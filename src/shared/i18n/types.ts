...
export interface TranslationSchema {
  ...
  impressumPage: {
    ...
    operatorDesc: string;
    operatorTaxNotice: string;
    postalAddressLabel: string;
    legalDomicileLabel: string;
    legalDomicileValue: string;
    representationHeading: string;
    presidentRole: string;
    presidentStatus: string;
    presidentBio: string;
    treasurerRole: string;
    treasurerStatus: string;
    treasurerBio: string;
    ...
    venueHeading: string;
    festivalName: string;
    venueNoticeLabel: string;
    venueNoticeText: string;
    ...
    copyrightP1: string;
    copyrightP2: string;
    dataProtectionHeading: string;
    dataProtectionP1: string;
    privacyPolicyLink: string;
    cookiePolicyLink: string;
    applicableLawHeading: string;
